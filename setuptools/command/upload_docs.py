...
class upload_docs(upload):
    ...
    # distutils stubs issue where the parent type "Command" is seen as a different source than in setuptools
    sub_commands = [('build_sphinx', has_sphinx)]  # type: ignore[list-item]
