...
# satisfy the linters.
_distribution_finders: Dict[type, _DistFinderType] = {}
_namespace_handlers: Dict[type, _NSHandlerType] = {}
...
def register_loader_type(
    loader_type: type,
    provider_factory: Callable[[_ModuleLike], "IResourceProvider"],
):
...
def get_distribution(dist: Union[_PkgReqType, "Distribution"]):
...
class IMetadataProvider(Protocol):
    ...
    def metadata_isdir(self, name: str):
...
class Environment:
    ...
    def best_match(
        ...
        installer: Optional[Callable[["Requirement"], _T]] = None,
        replace_conflicting: bool = False,
    ):
...
class ResourceManager:
    ...
    def resource_string(self, package_or_requirement: _PkgReqType, resource_name: str):
...
class ZipProvider(EggProvider):
    ...
    def __init__(self, module: _ModuleLike):
        super().__init__(module)
        self.zip_pre: str = self.loader.archive + os.sep
    ...
    @property
    def zipinfo(self) -> None:
        return self._zip_manifests.load("")
...
def register_finder(importer_type: type, distribution_finder: _DistFinderType):
...
def find_eggs_in_zip(importer: zipimport.zipimporter, path_item, only=False):
    """
...
def register_namespace_handler(importer_type: type, namespace_handler: _NSHandlerType):
...
class EntryPoint:
    ...
    def parse_map(
        cls,
        data: Union[str, Sequence[str], Dict[str, Union[str, Sequence[str]]]],
        dist: Optional["Distribution"] = None,
    ):
...
class Distribution:
    ...
    def insert_on(self, path: List[StrPath], loc=None, replace: bool = False):  # noqa: C901
