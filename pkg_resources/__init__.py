...
_StrictInstallerType = Callable[["Requirement"], _D]
_InstallerType = Optional[Callable[["Requirement"], Optional["Distribution"]]]
...
class VersionConflict(ResolutionError):
    ...
    args: Tuple["Distribution", "Requirement", "object"]
    if TYPE_CHECKING:

        def __init__(
            self, dist: "Distribution", req: "Requirement", /, *args: object
        ) -> None: ...
    ...
    def with_context(
        self, required_by: Set[str]
    ) -> Union["Self", "ContextualVersionConflict"]:
        """
...
class ContextualVersionConflict(VersionConflict):
    ...
    args: Tuple["Distribution", "Requirement", Set[str]]
    if TYPE_CHECKING:
...
class DistributionNotFound(ResolutionError):
    ...
    args: Tuple["Requirement", Optional[Set[str]]]

    if TYPE_CHECKING:

        def __init__(
            self, req: "Requirement", requirers: Optional[Set[str]], /, *args: object
        ) -> None: ...
...
def get_provider(
    moduleOrReq: Union[str, "Requirement"],
) -> Union["IResourceProvider", "Distribution"]:
    ...
    adapter = _find_adapter(_provider_factories, loader)
...
def get_distribution(dist: _EPDistType) -> "Distribution":
...
def get_entry_map(
    dist: _EPDistType, group: Optional[str] = None
) -> Union[Dict[str, "EntryPoint"], Dict[str, Dict[str, "EntryPoint"]]]:
...
class WorkingSet:
    ...
    @overload
    def resolve(  # type: ignore[overload-overlap] # Ordered from most to least precise
        self,
    ...
    def resolve(
        ...
        requirements: Iterable["Requirement"],
        env: Optional["Environment"] = None,
        installer: Union[_InstallerType, _StrictInstallerType[_D]] = None,
        replace_conflicting: bool = False,
        extras: Optional[Tuple[str, ...]] = None,
    ) -> Union[List["Distribution"], List[_D]]:
    ...
    @overload
    def find_plugins(  # type: ignore[overload-overlap] # Ordered from most to least precise
        self,
    ...
    def find_plugins(
        ...
        installer: Union[_InstallerType, _StrictInstallerType[_D]] = None,
        fallback: bool = True,
    ) -> Tuple[Union[List["Distribution"], List[_D]], Dict["Distribution", Exception]]:
...
class Environment:
    ...
    def best_match(
        ...
        installer: Union[_InstallerType, _StrictInstallerType[_D]] = None,
        replace_conflicting: bool = False,
    ) -> Optional[Union["Distribution", _D]]:
    ...
    def obtain(
        ...
        installer: Optional[Callable[["Requirement"], None]],
    ) -> None: ...
    @overload
    def obtain(
    ...
    def __iadd__(self, other: Union["Distribution", "Environment"]) -> "Self":
    ...
    def __add__(self, other: Union["Distribution", "Environment"]) -> "Self":
...
class ZipManifests(Dict[str, "MemoizedZipManifests.manifest_mod"]):
    ...
    @classmethod
    def build(cls, path: Union["StrPath", IO[bytes]]) -> _ZipManifestDict:
        """
...
class MemoizedZipManifests(ZipManifests):
    ...
    def load(self, path: str) -> _ZipManifestDict:
        """
...
class ZipLoaderModule(Protocol):
...
class ZipProvider(EggProvider):
    ...
    def __init__(self, module: ZipLoaderModule) -> None:
        super().__init__(module)
...
class FileMetadata(EmptyProvider):
    ...
    def get_metadata_lines(self, name) -> chain[str]:
        return yield_lines(self.get_metadata(name))
...
_distribution_finders: Dict[type, _DistFinderType[object]] = _declare_state(
...
_namespace_handlers: Dict[type, _NSHandlerType[object]] = _declare_state(
...
def fixup_namespace_packages(path_item: str, parent: Optional[str] = None) -> None:
...
class EntryPoint:
    ...
    def load(
        ...
        *args: Union[Environment, _InstallerType],
        **kwargs: Union[Environment, _InstallerType],
    ) -> _ResolvedEntryPoint: ...
    def load(
        self,
        require: bool = True,
    ...
    @classmethod
    def parse(cls, src: str, dist: Optional["Distribution"] = None) -> "Self":
    ...
    def parse_map(
        ...
        if isinstance(data, dict):
            # Cast needed because of bad type narrowing
            _data = cast(Dict[str, _NestedStr], data).items()
        else:
...
class Distribution:
    ...
    def hashcmp(
        self,
    ) -> Tuple[_packaging_version.Version, int, str, Optional[str], str, str]:
        return (
    ...
    def key(self) -> str:
        if not hasattr(self, "_key"):
            self._key = self.project_name.lower()
        return self._key
    ...
    def activate(self, path: Optional[List[str]] = None, replace: bool = False) -> None:
    ...
    def clone(
        self, **kw: Optional[Union[str, int, IResourceProvider]]
    ) -> "Requirement":
...
def parse_requirements(strs: Union[str, Iterable[str]]) -> "map[Requirement]":
    """
...
class Requirement(_packaging_requirements.Requirement):
    def __init__(self, requirement_string: str) -> None:
        ...
        self.extras = set(map(safe_extra, self.extras))
        self.hashCmp = (
            self.key,
            self.url,
            self.specifier,
